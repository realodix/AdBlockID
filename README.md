...
| AdBlockID+ (Adult) | - | - | **Discontinued**, akan dihapus pada 1/03/22. Gunakan AdBlockID Plus sebagai gantinya.  |

Lihat [tabel perbandingan](/docs/comparison_table.md) antara AdBlockID+ (Yang lama) dan AdBlockID Plus.
