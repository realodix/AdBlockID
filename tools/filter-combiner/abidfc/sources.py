""" Helper classes that handle IO for filter list parsing and combining. """
...
class NotFound(Exception):
    ...
    The file with requested name doesn't exist. If this results from an include, the
    including list probably contains an error.
    """
